...
const TestimonialCard = ({ imgUrl, name, occupaction, content }) => {
  return (
    <div className="flex flex-col items-center col-span-12 desktop:col-span-4">
      <Image src={imgUrl} width="72" height="72" className="rounded-full mb-8" alt={`Client ${name}'s avatar`} />
      <p className="text-lg font-semibold leading-8 text-very-dark-grayish-blue mb-8 desktop:mb-[69px]">{content}</p>
